...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "🔱 GUARDIAN 🔱 Chatbot enable by {}.".format(mention_html(user.id, user.first_name)),
                parse_mode=ParseMode.HTML,
            )
...
__help__ = """
🔱 GUARDIAN 🔱 Chatbot more interactive group chat experience.

*Admins only Commands*:
 • `/Chatbot`*:* Shows chatbot Options 
